...
export const KB_WISHLIST = [
  ...
  { topic: 'UAE MoE Arabic First Language (deep)', priority: 'MEDIUM', reason: 'Arabic first language curriculum goes deeper than current arabicSupportKB covers', estimatedSessionsAffected: 2000, dataSources: ['UAE MoE Arabic curriculum documents'], owner: 'pending', targetDate: '2026-07-01' },
