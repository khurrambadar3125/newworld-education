  ...
  const sendMessage = async (text) => {
    ...
    try {
      ...
      try {
        ...
        recordMessageSignal({ email: profile.email || 'anonymous', subject: 'Reading - ' + topic, grade: profile.grade || '', userMessage: txt, starkyResponse: reply, sessionNumber: 1 });
        recordStrategySignal({ email: profile.email || 'anonymous', subject: 'Reading - ' + topic, grade: profile.grade || '', starkyResponse: reply, userResponse: txt });
      } catch {}
