  ...
  const sendMessage = async (text) => {
    ...
    try {
      ...
      const res = await fetch("/api/chat", {
        ...
        body: JSON.stringify({ model: /* PERMANENT: Haiku 3 only. Never change without Khurrams approval. */ "claude-haiku-4-5-20251001", max_tokens: 800, system, messages: prev.map(m => ({ role: m.role, content: m.content })) }),
      });
