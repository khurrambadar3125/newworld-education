  ...
  const sendMessage = async (text) => {
    ...
    try {
      const res = await fetch("/api/chat",{
        ...
        body:JSON.stringify({model:/* PERMANENT: Haiku 3 only. Never change without Khurrams approval. */ "claude-haiku-4-5-20251001",max_tokens:1500,system:buildSystemPrompt(profile),messages:apiMessages}),
      });
