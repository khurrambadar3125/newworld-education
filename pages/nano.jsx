...
export default function NanoPage() {
  ...
  const buildNanoMessage = (goal, goalNumber, subject, isFirst = false) => {
    ...
    return `${firstPrefix}Starky, I am working on Nano Goal ${goalNumber} in ${subject}.\n\nThe goal is: "${goal.atom}"\n\nPlease follow these exact steps:\n\nSTEP 1 — TEACH\nExplain this concept clearly in 3-4 sentences. Use simple language. Give one real-world example if it helps. Do not test me yet.\n\nSTEP 2 — CHECK UNDERSTANDING\nAsk me ONE question to check I understood your explanation. Wait for my answer before moving on.\n\nSTEP 3 — CAMBRIDGE EXAM QUESTION\nGive me a real Cambridge exam question for this concept.\n\nBefore I answer, tell me:\na) The COMMAND WORD in the question and exactly what Cambridge requires for that command word\nb) How many marks it is worth\nc) The mark scheme PHRASES I must include — the exact words Cambridge accepts\n\nThen ask me to write my answer.\n\nSTEP 4 — MARK MY ANSWER\nWhen I submit my answer, mark it against the Cambridge mark scheme. Check:\n\na) COMMAND WORD compliance — did I answer what was actually asked?\nb) MARK SCHEME LANGUAGE — did I use the exact phrases Cambridge requires, or imprecise alternatives that lose marks? Correct any rejected phrases explicitly.\nc) EXAMINER REPORT — flag any mistake that Cambridge examiners specifically penalise for this topic.\nd) MARKS EARNED — which mark points did I hit?\ne) MARKS LOST — which mark points did I miss and exactly what phrase would earn them?\n\nOnly confirm NANO_GOAL_COMPLETE when the student has demonstrated both content knowledge AND correct Cambridge exam writing.\n\nSTEP 5 — CONFIRM COMPLETION\nIf I score full marks (or at least 70%):\nSay exactly this: "NANO_GOAL_COMPLETE:${goal.id}"\nThen say: "Goal ${goalNumber} mastered. Well done. You are ready for the next goal."\n\nIf I do not score full marks:\nGive me one more attempt with a hint.\nDo not confirm completion until I reach 70% or above.\n\nMy subject context: ${subject}\nMy goal ID: ${goal.id}\nMy goal difficulty: ${goal.difficulty}/5\nMy exam weight: ${goal.examWeight}`;
  };
