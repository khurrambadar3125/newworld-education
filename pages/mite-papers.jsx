...
const PAPER_SOURCES = [
  ...
  },
  {
    ...
    papers: [
      { name: 'LCAT Sample 2025', url: '#', note: 'Available on lums.edu.pk' },
    ],
  },
  {
    ...
    papers: [
      { name: 'LAT Sep 2020', url: '#' },
      { name: 'LAT Dec 2020', url: '#' },
      { name: 'LAT Mar 2021', url: '#' },
      { name: 'LAT Aug 2021', url: '#' },
      { name: 'LAT Nov 2021', url: '#' },
      { name: 'LAT Jan 2022', url: '#' },
      { name: 'LAT May 2022', url: '#' },
      { name: 'LAT Aug 2022', url: '#' },
      { name: 'LAT Nov 2022', url: '#' },
      { name: 'LAT Jan 2023', url: '#' },
      { name: 'LAT Jul 2023', url: '#' },
      { name: 'LAT Aug 2023', url: '#' },
      { name: 'LAT Nov 2023', url: '#' },
      { name: 'LAT Feb 2024', url: '#' },
      { name: 'LAT Preparation Book', url: '#' },
    ],
  },
  {
    ...
    papers: [
      { name: 'GAT Past Paper Aug 2022', url: '#' },
      { name: 'GAT Past Paper with Solutions', url: '#' },
      { name: 'NAT-ICS (Computer Science)', url: '#' },
      { name: 'NAT-IE (Engineering)', url: '#' },
      { name: 'NAT-IM (Medical)', url: '#' },
      { name: 'NAT-ICOM (Commerce)', url: '#' },
    ],
  },
  {
    ...
    papers: [
      { name: 'Programming Fundamentals', url: '#', note: '40+ papers' },
      { name: 'Data Structures', url: '#', note: '35+ papers' },
      { name: 'OOP', url: '#', note: '30+ papers' },
      { name: 'Database Systems', url: '#', note: '25+ papers' },
      { name: 'Algorithms', url: '#', note: '20+ papers' },
      { name: 'Operating Systems', url: '#', note: '20+ papers' },
      { name: 'Computer Networks', url: '#', note: '15+ papers' },
      { name: 'And 30+ more courses...', url: '#' },
    ],
  },
];
