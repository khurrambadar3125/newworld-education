    ...
    <div style={{minHeight:'100vh',background:'#080C18',color:'#fff',fontFamily:"'Nunito',-apple-system,sans-serif",padding:'40px 20px 80px'}}>
      ...
      <div style={{maxWidth:680,margin:'0 auto'}}>
        ...
        <div style={{fontSize:15,lineHeight:1.8,color:'rgba(255,255,255,0.75)'}}>
          ...
          <p>The Platform's SEN features are informed by publicly available educational research and frameworks. References to educational standards, assessment frameworks, or teaching methodologies (such as structured literacy approaches, engagement-based assessment models, or questioning frameworks) are for informational context only. NewWorld Education is not affiliated with, endorsed by, or licensed by the creators or governing bodies of any referenced framework, standard, or methodology.</p>
