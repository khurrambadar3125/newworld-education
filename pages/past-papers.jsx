...
// Topics from textbook-accurate SYLLABUS (used to populate topTopics)
import { getTopicsForSubject } from '../utils/syllabusStructure';
const _syllabusTopics = (name) => { const t = getTopicsForSubject(name); return t.length > 0 ? t.slice(0, 8) : null; };
...
const SUBJECTS = {
  olevel: [
    { id:"o-maths",     name:"Mathematics D",    code:"4024", emoji:"🔢", color:"#63D2FF",
      ...
      topTopics: _syllabusTopics('Mathematics') || ["Algebra & quadratics","Trigonometry","Coordinate geometry","Statistics & probability","Matrices","Transformations","Mensuration"],
    ...
    { id:"o-physics",   name:"Physics",           code:"5054", emoji:"⚛️", color:"#A8E063",
      ...
      topTopics: _syllabusTopics('Physics') || ["Forces & motion","Electricity & circuits","Waves & light","Thermal physics","Magnetism","Nuclear physics"],
    ...
    { id:"o-chemistry", name:"Chemistry",          code:"5070", emoji:"🧪", color:"#C77DFF",
      ...
      topTopics: _syllabusTopics('Chemistry') || ["Atomic structure","Bonding","Acids & bases","Redox reactions","Organic chemistry","Rates of reaction","Periodic table"],
    ...
    { id:"o-biology",   name:"Biology",            code:"5090", emoji:"🧬", color:"#FF8C69",
      ...
      topTopics: _syllabusTopics('Biology') || ["Cell biology","Transport in plants & animals","Respiration & photosynthesis","Reproduction","Genetics & inheritance","Ecology","Biotechnology"],
    ...
    { id:"o-english",   name:"English Language",   code:"1123", emoji:"📖", color:"#FFC300",
      ...
      topTopics: _syllabusTopics('English Language') || ["Reading comprehension","Summary writing","Directed writing","Narrative composition","Descriptive composition"],
    ...
    { id:"o-urdu",      name:"Urdu",               code:"3247", emoji:"✍️", color:"#63D2FF",
      ...
      topTopics: _syllabusTopics('Urdu') || ["Reading comprehension","Essay writing","Letter writing","Summary"],
    ...
    { id:"o-islamiyat", name:"Islamiyat",           code:"2058", emoji:"☪️", color:"#52C97A",
      ...
      topTopics: _syllabusTopics('Islamiyat') || ["Life of the Prophet ﷺ","Quran — selected passages","Hadith — selected","The Rightly-Guided Caliphs","Islamic practices"],
    ...
    { id:"o-history",   name:"History",             code:"2147", emoji:"🏛️", color:"#FF6B6B",
      ...
      topTopics: _syllabusTopics('History') || ["Source analysis","WWI causes","WWII causes","Cold War","League of Nations","Indian independence"],
    ...
    { id:"o-economics", name:"Economics",           code:"2281", emoji:"📊", color:"#FFC300",
      ...
      topTopics: _syllabusTopics('Economics') || ["Supply & demand","Market structures","Macroeconomics","International trade","Government policies","Labour market"],
    ...
    { id:"o-geography", name:"Geography",           code:"2217", emoji:"🌍", color:"#4ECDC4",
      ...
      topTopics: _syllabusTopics('Geography') || ["River processes","Earthquakes & volcanoes","Weather & climate","Population","Settlement","Migration","Industry","Map skills"],
    ...
    { id:"o-cs",        name:"Computer Science",    code:"2210", emoji:"💻", color:"#C77DFF",
      ...
      topTopics: _syllabusTopics('Computer Science') || ["Data representation","Logic gates","Networking","Algorithms & pseudocode","Programming","Databases","Security"],
    ...
    { id:"o-pakstudies",name:"Pakistan Studies",    code:"2059", emoji:"🇵🇰", color:"#00A86B",
      ...
      topTopics: _syllabusTopics('Pakistan Studies') || ["Movement for Pakistan 1857-1947","Pakistan 1947-present","Culture & heritage","Physical geography","Agriculture & industry","Population"],
    ...
    { id:"o-business",  name:"Business Studies",    code:"7115", emoji:"💼", color:"#63D2FF",
      ...
      topTopics: _syllabusTopics('Business Studies') || ["Business objectives","Marketing","Production","Finance","HR management","External environment"],
    ...
    { id:"o-accounts",  name:"Accounting",          code:"7707", emoji:"📒", color:"#A8E063",
      ...
      topTopics: _syllabusTopics('Accounting') || ["Double entry","Trial balance","Income statement","Balance sheet","Cash flow","Depreciation","Bank reconciliation"],
    ...
    { id:"o-sociology", name:"Sociology",           code:"2251", emoji:"👥", color:"#FF8C69",
      ...
      topTopics: _syllabusTopics('Sociology') || ["Social inequality","Education","Family","Crime & deviance","Media","Research methods"],
    ...
    { id:"o-addmaths", name:"Additional Mathematics", code:"4037", emoji:"📐", color:"#A78BFA",
      ...
      topTopics: _syllabusTopics('Additional Mathematics') || ["Quadratics & polynomials","Trigonometry","Calculus","Logarithms","Coordinate geometry","Kinematics","Binomial theorem"],
...
export default function PastPapersPage() {
  ...
  const sendMessage = async (text, pdfOverride) => {
    ...
    try {
      ...
      const model = /* PERMANENT: Haiku 3 only. Never change without Khurrams approval. */ "claude-haiku-4-5-20251001";
