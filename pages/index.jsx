...
export default function Home() {
  ...
  const launchChat = (profile, subjectOverride) => {
    ...
    } else if (isMatric || userProfile?.board === 'sindh') {
      greeting = `Assalam-o-Alaikum ${firstName}! Starky here ★\n\nMain aap ka ${subject || 'Matric'} syllabus poora jaanta hoon — har numerical, har definition, har diagram jo BISE examiner chahta hai.\n\n${subject ? `${subject} ke baare mein kuch bhi poochein, apni notes ki photo bhejein, ya "quiz me" kehein.` : 'Apna sawaal likhein, notes ki photo bhejein, ya "quiz me" kehein.'}\n\nUrdu, Sindhi, ya English — jo aap ko easy lage 🇵🇰\n\n💡 Aap ke notes aur chapters: newworld.education/sindh-board`;
    } else {
        ...
        <div className="dr" onClick={() => { setMenuOpen(false); document.body.style.overflow = ''; }}>
          ...
          {userCountry === 'UAE' ? (
            <>
              ...
              <a href="/special-needs">💜 Students of Determination</a>
