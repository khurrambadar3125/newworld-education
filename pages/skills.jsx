...
const TRACKS = [
  {
    ...
    modules: [
      ...
      { id: 'f2', name: 'Canva Design Mastery', lessons: ['Canva Basics — Your First Design', 'Social Media Posts', 'Logo Design', 'YouTube Thumbnails', 'Business Cards & Flyers', 'Building Your Portfolio'], weeks: '3-4', icon: '🎨' },
