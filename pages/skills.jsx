...
const TRACKS = [
  {
    ...
    modules: [
      ...
      { id: 'f2', name: 'Graphic Design — Zero to Professional', lessons: [
        'Canva — Pehla Design Banayein',
        'Canva — Social Media Posts & Stories',
        'Canva — Logo Design & Branding',
        'GIMP — Free Photoshop Alternative (Install & Basics)',
        'GIMP — Photo Editing & Retouching',
        'GIMP — Layers, Masks, Filters',
        'Photopea.com — Browser Mein Photoshop (Free)',
        'Photopea — Professional Photo Manipulation',
        'Inkscape — Free Illustrator Alternative (Vector Graphics)',
        'Inkscape — Logo Design With Vectors',
        'Inkscape — Business Cards, Flyers, Posters',
        'Portfolio Banayein — Behance/Dribbble Profile Setup',
      ], weeks: '3-6', icon: '🎨' },
