  ...
  return (
    <div style={{ minHeight: '100vh', background: NAVY, fontFamily: "'Sora',-apple-system,sans-serif", color: WHITE }}>
      <Head>
        ...
        <meta name="description" content="MiTE and NewWorldEdu bring AI-powered learning to university students. Entrance test prep, AI tutoring, and learning analytics for BBA, BSCS, and Law programs." />
      ...
      <section style={{ maxWidth: 800, margin: '0 auto', padding: isMobile ? '0 20px 40px' : '0 24px 60px' }}>
        <div style={{ background: 'rgba(201,168,76,0.04)', border: '1px solid rgba(201,168,76,0.15)', borderRadius: 20, padding: isMobile ? '24px 20px' : '40px 36px' }}>
          ...
          <p style={{ fontSize: 16, color: 'rgba(250,246,235,0.7)', lineHeight: 1.9, margin: '0 0 16px' }}>
            But university is different. The syllabus is wider. The competition is fiercer. And coaching centres don't exist for BBA, BSCS, or Law programs.
          </p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr 1fr', gap: 14 }}>
          ...
          <div style={{ background: 'rgba(250,246,235,0.03)', border: '1px solid rgba(250,246,235,0.06)', borderRadius: 16, padding: '28px 20px' }}>
            ...
            <div style={{ fontSize: 13, color: 'rgba(250,246,235,0.55)', lineHeight: 1.7 }}>
              AI-powered preparation for MiTE's BBA, BSCS, and Law admission tests. Personalised practice from a verified question bank. Students arrive prepared — not guessing.
            </div>
            <div style={{ marginTop: 12, fontSize: 12, color: 'rgba(250,246,235,0.35)' }}>
              ✓ BBA aptitude + verbal reasoning<br/>
              ✓ BSCS logical + programming aptitude<br/>
              ✓ Law analytical reasoning + comprehension<br/>
          ...
          <div style={{ background: 'rgba(250,246,235,0.03)', border: '1px solid rgba(250,246,235,0.06)', borderRadius: 16, padding: '28px 20px' }}>
            ...
            <div style={{ fontSize: 13, color: 'rgba(250,246,235,0.55)', lineHeight: 1.7 }}>
              Starky — a personal AI tutor available 24/7. Understands BBA, BSCS, and Law syllabi. Answers in English, Urdu, or Roman Urdu. Never judges. Never gives up.
            </div>
            <div style={{ marginTop: 12, fontSize: 12, color: 'rgba(250,246,235,0.35)' }}>
      ...
      <section style={{ maxWidth: 800, margin: '0 auto', padding: isMobile ? '0 20px 40px' : '0 24px 60px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr 1fr', gap: 16 }}>
          {[
            ...
            { n: '2', title: 'Integration — 90 Days', sub: 'Course-level deployment.', items: ['Custom content for BBA/BSCS/Law courses', 'Faculty analytics dashboard deployed', 'Student performance tracking', 'MiTE-branded experience'], active: false },
